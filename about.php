...
<head>
    ...
    <!-- Page Title -->
    <title>Architects in Coimbatore|House architects at best price</title>
            ...
            <div class="container">
                <div class="mission_top_part">
                    <div class="section-header text-center">
                        <h1 class="text-white text-uppercase">Building Dreams with Innovation and Excellence | Trusted Builders in Coimbatore</h1>
                        <p class="text-gray-600 custom_color_para">
            ...
            <div class="container">
                <div class="row justify-content-center" data-aos="flip-up" data-aos-duration="500">
                    <div class="col-lg-11 p-lg-0">
                        <p class="about_para text-center">we meet new people <span><a href="#">everyday</a></span>
                            coming with <span><a href="#">new dreams & hope our effort is to make them true</a></span>
                        </p>
                    </div>
                </div>
            </div>
